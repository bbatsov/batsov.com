...
While the language lost traction in recent years, I think that its legacy is alive and well - most notably as a replacement for `sed` and `awk`, and in Ruby.[^2] Happy birthday, Perl!
