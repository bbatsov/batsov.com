...
- Emacs 29 has built-in support for modern technologies like [LSP](https://www.gnu.org/software/emacs/manual/html_node/eglot/index.html) and [Tree-sitter](https://www.masteringemacs.org/article/how-to-get-started-tree-sitter)
...
Much of this happened in the last 5 years, which is pretty amazing for a dying editor that has been rendered irrelevant by its vastly superior competitors.
