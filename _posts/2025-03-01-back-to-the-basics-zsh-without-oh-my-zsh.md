...
Now I know everything in my Zsh setup and I frankly don't miss anything from OMZ.
...
really need the whole OMZ to be able to use it. [Antidote](https://antidote.sh/) is a
Zsh plugin manager that allows you to install OMZ plugins, if you really need
